...
module Instant.Grammar.ParInstant (
    happyError,
    myLexer,
    pProgram,
    pStmt,
...
import qualified Instant.Grammar.AbsInstant
import Instant.Grammar.LexInstant
import Prelude
...
#endif
newtype HappyWrap11 = HappyWrap11 ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Ident))

happyIn11 :: ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Ident)) -> (HappyAbsSyn)
...
newtype HappyWrap12 = HappyWrap12 ((Instant.Grammar.AbsInstant.BNFC'Position, Integer))

happyIn12 :: ((Instant.Grammar.AbsInstant.BNFC'Position, Integer)) -> (HappyAbsSyn)
...
newtype HappyWrap13 = HappyWrap13 ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Program))

happyIn13 :: ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Program)) -> (HappyAbsSyn)
...
newtype HappyWrap14 = HappyWrap14 ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Stmt))

happyIn14 :: ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Stmt)) -> (HappyAbsSyn)
...
newtype HappyWrap15 = HappyWrap15 ((Instant.Grammar.AbsInstant.BNFC'Position, [Instant.Grammar.AbsInstant.Stmt]))

happyIn15 :: ((Instant.Grammar.AbsInstant.BNFC'Position, [Instant.Grammar.AbsInstant.Stmt])) -> (HappyAbsSyn)
...
newtype HappyWrap16 = HappyWrap16 ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp))

happyIn16 :: ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp)) -> (HappyAbsSyn)
...
newtype HappyWrap17 = HappyWrap17 ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp))

happyIn17 :: ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp)) -> (HappyAbsSyn)
...
newtype HappyWrap18 = HappyWrap18 ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp))

happyIn18 :: ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp)) -> (HappyAbsSyn)
...
newtype HappyWrap19 = HappyWrap19 ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp))

happyIn19 :: ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp)) -> (HappyAbsSyn)
...
newtype HappyWrap20 = HappyWrap20 ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp))

happyIn20 :: ((Instant.Grammar.AbsInstant.BNFC'Position, Instant.Grammar.AbsInstant.Exp)) -> (HappyAbsSyn)
...
happyExpListPerState st =
    token_strs_expected
  where
    token_strs = ["error", "%dummy", "%start_pProgram_internal", "%start_pStmt_internal", "%start_pListStmt_internal", "%start_pExp1_internal", "%start_pExp2_internal", "%start_pExp3_internal", "%start_pExp4_internal", "%start_pExp_internal", "Ident", "Integer", "Program", "Stmt", "ListStmt", "Exp1", "Exp2", "Exp3", "Exp4", "Exp", "'('", "')'", "'*'", "'+'", "'-'", "'/'", "';'", "'='", "L_Ident", "L_integ", "%eof"]
...
happyReduction_8 happy_x_1 =
    case happyOutTok happy_x_1 of
        happy_var_1 ->
            happyIn11
                ( (uncurry Instant.Grammar.AbsInstant.BNFC'Position (tokenLineCol happy_var_1), Instant.Grammar.AbsInstant.Ident (tokenText happy_var_1))
                )
...
happyReduction_9 happy_x_1 =
    case happyOutTok happy_x_1 of
        happy_var_1 ->
            happyIn12
                ( (uncurry Instant.Grammar.AbsInstant.BNFC'Position (tokenLineCol happy_var_1), (read (tokenText happy_var_1)) :: Integer)
                )
...
happyReduction_10 happy_x_1 =
    case happyOut15 happy_x_1 of
        (HappyWrap15 happy_var_1) ->
            happyIn13
                ( (fst happy_var_1, Instant.Grammar.AbsInstant.Prog (fst happy_var_1) (snd happy_var_1))
                )
            ...
            (HappyWrap11 happy_var_1) ->
                case happyOut20 happy_x_3 of
                    (HappyWrap20 happy_var_3) ->
                        happyIn14
                            ( (fst happy_var_1, Instant.Grammar.AbsInstant.SAss (fst happy_var_1) (snd happy_var_1) (snd happy_var_3))
                            )
...
happyReduction_12 happy_x_1 =
    case happyOut20 happy_x_1 of
        (HappyWrap20 happy_var_1) ->
            happyIn14
                ( (fst happy_var_1, Instant.Grammar.AbsInstant.SExp (fst happy_var_1) (snd happy_var_1))
                )
...
happyReduction_13 =
    happyIn15
        ( (Instant.Grammar.AbsInstant.BNFC'NoPosition, [])
        )
            ...
            (HappyWrap17 happy_var_1) ->
                case happyOut16 happy_x_3 of
                    (HappyWrap16 happy_var_3) ->
                        happyIn16
                            ( (fst happy_var_1, Instant.Grammar.AbsInstant.ExpAdd (fst happy_var_1) (snd happy_var_1) (snd happy_var_3))
                            )
            ...
            (HappyWrap17 happy_var_1) ->
                case happyOut18 happy_x_3 of
                    (HappyWrap18 happy_var_3) ->
                        happyIn17
                            ( (fst happy_var_1, Instant.Grammar.AbsInstant.ExpSub (fst happy_var_1) (snd happy_var_1) (snd happy_var_3))
                            )
...
happyReduction_20
    ...
    happy_x_1 =
        case happyOut18 happy_x_1 of
            (HappyWrap18 happy_var_1) ->
                case happyOut19 happy_x_3 of
                    (HappyWrap19 happy_var_3) ->
                        happyIn18
                            ( (fst happy_var_1, Instant.Grammar.AbsInstant.ExpMul (fst happy_var_1) (snd happy_var_1) (snd happy_var_3))
                            )
        ...
        case happyOut18 happy_x_1 of
            (HappyWrap18 happy_var_1) ->
                case happyOut19 happy_x_3 of
                    (HappyWrap19 happy_var_3) ->
                        happyIn18
                            ( (fst happy_var_1, Instant.Grammar.AbsInstant.ExpDiv (fst happy_var_1) (snd happy_var_1) (snd happy_var_3))
                            )
...
happyReduction_23 happy_x_1 =
    case happyOut12 happy_x_1 of
        (HappyWrap12 happy_var_1) ->
            happyIn19
                ( (fst happy_var_1, Instant.Grammar.AbsInstant.ExpLit (fst happy_var_1) (snd happy_var_1))
                )
...
happyReduction_24 happy_x_1 =
    case happyOut11 happy_x_1 of
        (HappyWrap11 happy_var_1) ->
            happyIn19
                ( (fst happy_var_1, Instant.Grammar.AbsInstant.ExpVar (fst happy_var_1) (snd happy_var_1))
                )
            ...
            happy_var_1 ->
                case happyOut20 happy_x_2 of
                    (HappyWrap20 happy_var_2) ->
                        happyIn19
                            ( (uncurry Instant.Grammar.AbsInstant.BNFC'Position (tokenLineCol happy_var_1), (snd happy_var_2))
                            )
...
pProgram :: [Token] -> Err Instant.Grammar.AbsInstant.Program
pProgram = fmap snd . pProgram_internal

pStmt :: [Token] -> Err Instant.Grammar.AbsInstant.Stmt
pStmt = fmap snd . pStmt_internal

pListStmt :: [Token] -> Err [Instant.Grammar.AbsInstant.Stmt]
pListStmt = fmap snd . pListStmt_internal

pExp1 :: [Token] -> Err Instant.Grammar.AbsInstant.Exp
pExp1 = fmap snd . pExp1_internal

pExp2 :: [Token] -> Err Instant.Grammar.AbsInstant.Exp
pExp2 = fmap snd . pExp2_internal

pExp3 :: [Token] -> Err Instant.Grammar.AbsInstant.Exp
pExp3 = fmap snd . pExp3_internal

pExp4 :: [Token] -> Err Instant.Grammar.AbsInstant.Exp
pExp4 = fmap snd . pExp4_internal

pExp :: [Token] -> Err Instant.Grammar.AbsInstant.Exp
